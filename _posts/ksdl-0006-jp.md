...
Google Drive/MEGAなどのホスティングサイトにミックスをアップロードし、アクセスリンクを私たちのマスタリングエンジニアmalicentに、できればDiscordメッセージ（malicent_）、またはメール（kodamasoft@protonmail.com）、またはTwitter（@KodamaSoftあるいは@Fivda_のプライベートメッセージ）でお送りください。

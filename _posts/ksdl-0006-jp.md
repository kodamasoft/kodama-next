...
Google Drive/MEGAなどのホスティングサイトにミックスをアップロードし、アクセスリンクを私たちのマスタリングエンジニアmalicentに、できればDiscordメッセージ（malicent_）、またはメール（kodamasoft@proton.me）、またはTwitter（@KodamaSoftあるいは@Fivda_のプライベートメッセージ）でお送りください。

...
export default function LaMulanaFooter({ title, slug, footer_string }) {
	...
	return (
		<footer className={lmFontVars} style={{
			background: LM.black,
			...
			<div style={{
				...
				&copy; 2026 KodamaSounds &amp; Enga Musica. All rights reserved.<br />
				LA-MULANA &copy; NIGORO. LA-MULANA is a trademark of NIGORO.
				{footer_string && (
					<p style={{ marginTop: '1rem', maxWidth: '42rem', fontSize: '0.6rem' }}>

...
// Specifically for the Iron Fist music player
// You would realize this is a duplicate code, this is alright, I just want to keep the code splitting consistent
...
export default function SeekBar({ className }) {
	...
	return (
		...
		>
			...
			<div className="w-full h-0.5 rounded-full bg-namco70-if-accent-3/20 overflow-hidden">
				{/* Progress fill */}
				<div
					className="h-full bg-namco70-if-accent-3 rounded-full transition-all ease-out"
					style={{
						width: `${localValue}%`,

...
const buttonVariant = cva(
	'inline-flex items-center justify-center whitespace-nowrap w-full h-full py-4 cursor-pointer',
	{
		variants: {
			variant: {
				...
				if: 'border border-namco70-if-stroke text-lg bg-namco70-if-accent-2 hover:bg-namco70-if-foreground/20 sm:text-2xl font-medium',
			},
		},
		defaultVariants: {
			variant: 'default',

...
const iconLinks = [
	{ href: 'mailto:kodamasoft@protonmail.com', icon: FaEnvelope },
	...
	{ href: 'https://kodamasounds.bandcamp.com', icon: FaBandcamp },
		...
		<footer className="border-t border-slate-500/20 mt-10">
			<div className="container max-w-4xl mx-auto flex py-8 flex-col text-center">
				...
				<p className="text-slate-500 mt-5">
					KodamaSoft / KodamaSounds logo by{' '}
					<a
						href="https://twitter.com/vgmcal"
					...
					<a
						href="https://twitter.com/krz0001"
						className="text-slate-500 transition hover:text-slate-50 hover:underline"
					>
						krz
					</a>{' '}

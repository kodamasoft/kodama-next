...
*Terms last updated: 2026, July 9th*
...
- Similarly to physical goods, **you must agree with us publishing our albums on major streaming platforms** (Spotify, Apple Music, Deezer…) after they have initially been released on Bandcamp/BOOTH (except for tribute albums, which are exclusively available on Bandcamp/BOOTH). At the moment of streaming distribution, we will ensure that your track’s metadata will be appropriately linked to the correct artist page. Such matters can be discussed with us at any time so we can adapt in the best possible ways. **Starting July 2026, streaming revenues will no longer be included in the yearly royalties rollout. Since our transition to a different distributor, releases specific monthly sale reports are not logistically comprehensive to acquire based on our payment system. Other than that, revenues on streaming platforms have always been lackluster, to the point where the revenues can’t even match the price needed to maintain our streaming distribution in place. Therefore, any revenues accrued through streaming platforms will be directly used to help manage our distribution subscription instead, with any excess used to fund future KodamaSoft / KodamaSounds releases. As a reminder, distribution on streaming platforms is strictly for the sake of visibility and availability, even if it comes at a cost.**
